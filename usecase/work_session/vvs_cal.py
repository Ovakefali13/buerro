...
from adapter import VVSAdapter, CaldavAdapter
...
if __name__ == "__main__":
    ...
    [print(str(i) + ':\n' + str(j) + '\n') for i, j in enumerate(sorted_by_arrival)]
    ...
    chosen_journey = sorted_by_arrival[int(input("Which do you want to take? "))]
