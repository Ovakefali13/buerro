...
class Cook(Usecase):
    ...
    def advance(self, message):
        ...
        if self.no_time:
            ...
            if not list:
                return Reply(
                    {
                        "message": 'Please specify a ingredient like this "I like to cook with pork"'
                    }
                )
            if list[0][1] == "":
            ...
            if self.no_time:
                ...
                return Reply(
                    {
                        "message": "No time to cook. Would you like to get a restaurant in your area? (Yes/No)"
                    }
                )
            else:
                self.finished = True
    ...
    def set_calender(self):
        ...
        self.cooking_event.set_end(
            self.cooking_event.get_start() + timedelta(minutes=cooking_time)
        )
