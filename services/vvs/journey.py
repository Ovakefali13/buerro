...
class Journey:
    ...
    def to_link(self):
        link = "".join(
            """https://www3.vvs.de/mng/#!/XSLT_TRIP_REQUEST2@details?
            deeplink={
                **dateTime**:{
                    **date**:**DATE**,
                    **dateFormat**:****,
    ...
    def from_vvs(self, vvs_journey: dict):
        ...
        self.transportation = list(
            map(lambda l: l.get("transportation").get("name", "foot"), legs)
        )
        ...
        for leg in vvs_journey.get("legs"):
            ...
            leg_journey.set_transportation(
                leg.get("transportation").get("name", "foot")
            )
